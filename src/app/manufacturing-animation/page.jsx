...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Processes",
    description: "Full production process animation showing how raw materials move through assembly to become a finished product, start to finish.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Safety",
    description: "Standardized safety training animation deployed consistently across facilities, shifts, and new employee onboarding programs.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Machinery",
    description: "Equipment and machinery animation used for technical sales, training, and internal engineering documentation shared across teams.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Manufacturing <span>Animation</span> Projects</>}
        description="Across plants and equipment manufacturers, three project types come up most often, each solving a different communication gap on the floor."
