...
const whyChooseSectionFeatures = [
  {
    ...
    description: "Raw research data, assay results, and lab findings translated into clear visual sequences for internal teams, publications, conference posters, and investor updates.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Drug Mechanisms",
    description: "Mechanism of action animations showing how a compound engages its biological target at the cellular and molecular level, built to withstand scrutiny from reviewers, KOLs, and specialists.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Investor Presentations",
    description: "Focused explainer assets supporting fundraising rounds, board updates, and partner due diligence, sized to fit inside a pitch deck without overwhelming a business audience.",
    icon: "/industry/services-icon-03.png",
  },
  {
    id: 4,
    title: "Product Demos",
    description: "Accurate walkthroughs of how a device, platform, or therapy functions, built for sales teams, medical affairs, and physician education programs that need one approved source of visual truth.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common BioTech <span>Animation</span> Projects</>}
        description="Most engagements with our medical animation studio fall into one of four project types, though many clients combine two or more into a single production once the core scientific assets exist."
