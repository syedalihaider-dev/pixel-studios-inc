...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Software",
    description: "Product and feature animation for SaaS platforms, applications, and digital tools across every stage of the customer journey.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "AI",
    description: "Animation explaining machine learning models, AI-powered features, and data processes to both technical and non-technical audiences.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Product Launches",
    description: "Launch-focused animation generating buzz and clarity around a new product or major feature release your team is planning.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Technology <span>Animation</span> Projects</>}
        description="Across software, AI, and hardware companies, three project types come up most often, each tied to a specific point in the customer journey."
