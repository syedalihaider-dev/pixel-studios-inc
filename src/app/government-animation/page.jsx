...
const whyChooseSectionFeatures = [
  {
    ...
    description: "Public-facing animation explaining programs, services, and civic processes in accessible, plain language that reaches beyond people who already seek out written notices.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Training",
    description: "Internal training content for agency staff, covering procedures, safety, and policy updates, deployable consistently across departments and locations.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Government <span>Animation</span> Projects</>}
        description="Most agency engagements fall into two broad categories, each reaching a different audience with a different level of formal review."
