...
const whyChooseSectionFeatures = [
  {
    ...
    description: "Hero videos and teaser content that introduce a new product with maximum visual impact across homepage, email, and social, timed to build anticipation ahead of a drop date.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Ads",
    description: "3d animation video ads engineered for scroll-stopping performance on paid social, display, and connected TV, with hooks built for the first two seconds of a feed.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Social Media",
    description: "Short-form, platform-native cuts optimized for Instagram, TikTok, and YouTube Shorts. Vertical, fast, and built to hold attention without sound.",
    icon: "/industry/services-icon-03.png",
  },
  {
    id: 4,
    title: "Product Pages",
    description: "On-page video assets that reduce buyer hesitation and support the ecommerce testimonial video and demo content shoppers scan before checkout.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Ecommerce <span>Animation</span> Projects</>}
        description="Where do brands typically deploy this work? Across four high-leverage moments in the customer journey, each with its own format, length, and pacing requirements."
