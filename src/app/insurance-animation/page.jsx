...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Claims",
    description: "Step-by-step claims process animations that set clear expectations and reduce anxious follow-up calls during an already stressful moment for a customer who just experienced a loss.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Policies",
    description: "Coverage and policy explainer videos that make dense terms and tiers easy to compare at a glance, without rereading a document twice.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Customer Education",
    description: "Educational animation covering insurance basics, used for onboarding new customers and building trust across the life of the policy relationship.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Insurance <span>Animation</span> Projects</>}
        description="Across carriers, brokers, and insurtech platforms, three project types account for most of the insurance video production work we deliver, each targeting a measurable business outcome."
