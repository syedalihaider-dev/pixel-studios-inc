...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Investments",
    description: "Animation explaining investment products, strategies, and portfolio concepts for clients and prospects who need a clearer picture before committing capital.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Banking",
    description: "Product and service animation for retail and commercial banking clients, from account types to digital banking tools and mobile app features.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Compliance",
    description: "Animation supporting compliance training and communication, built to stay accurate to regulatory language while remaining genuinely easy to follow.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Finance <span>Animation</span> Projects</>}
        description="Across banks, investment firms, and fintech companies, three project types come up most often, each tied to a specific stage of the client relationship."
