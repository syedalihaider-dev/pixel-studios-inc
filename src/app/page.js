...
const bannerSlides = [
  {
    ...
    description: "Pixel Studios Inc. is your go-to animation studio for custom animation services that fit your brand and your goals. From 2D and 3D animation to explainer videos and motion graphics, we create engaging visuals that simplify your message, connect with your audience, and help your business make an impact."
  },
  // {
...
export const metadata = {
  ...
  description: "Need video animation services that convert browsers into buyers? Pixel Studios Inc builds custom 2D & 3D animation for brands across the USA. Get a free quote",
};
