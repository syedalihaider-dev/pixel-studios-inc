...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Supply Chain",
    description: "Full network visualizations for sales, partner, and investor conversations, covering every mode involved in moving freight from point to point.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Fleet",
    description: "Vehicle and transport animations showcasing routing, tracking, and delivery capability to enterprise clients evaluating your service against competitors.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Warehouse",
    description: "Facility and automation animations for operations marketing, client onboarding, and internal training across sites with varying levels of automation.",
    icon: "/industry/services-icon-03.png",
  },
  {
    id: 4,
    title: "Safety",
    description: "Standardized safety training animations deployed consistently across every facility, regardless of local language, shift patterns, or crew turnover.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Logistics <span>Animation</span> Projects</>}
        description="Across 3PLs, carriers, and warehouse operators, four project types come up again and again, each serving a different audience inside and outside the company."
