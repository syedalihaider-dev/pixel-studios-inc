...
const whyChooseSectionFeatures = [
  {
    ...
    description: "Feature-focused animation highlighting specific technology, safety systems, or design elements for marketing and sales enablement at the dealership level.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Manufacturing",
    description: "Process animation showing production line sequences and assembly for internal training, supplier coordination, and stakeholder presentations.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Automotive <span>Animation</span> Projects</>}
        description="Most manufacturer and supplier engagements fall into two broad categories, each serving different teams inside the same organization."
