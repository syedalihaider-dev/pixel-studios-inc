...
const whyChooseSectionFeatures = [
  {
    id: 1,
    title: "Campaigns",
    description: "Full campaign builds spanning TV, social, and display, all produced from one consistent creative concept so the message stays coherent wherever a viewer encounters it.",
    icon: "/industry/services-icon-01.png",
  },
  {
    id: 2,
    title: "Brand Awareness",
    description: "Broad-reach animated content built to introduce or reintroduce a brand to a new audience, prioritizing memorability over a direct call to action.",
    icon: "/industry/services-icon-02.png",
  },
  {
    id: 3,
    title: "Product Launches",
    description: "Launch-focused animation that generates buzz and explains a new product's core benefit quickly, timed to a specific release date and media push.",
  ...
  return (
    <main>
      ...
      />
        ...
        title={<>Common Advertising <span>Animation</span> Projects</>}
        description="Most agency and brand engagements fall into three categories, and because assets are built to be reused, a second project type usually costs a fraction of the first."
