          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Gaming <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Development pipelines are unforgiving of delay, so our process is built to plug into your existing production schedule rather than run on its own separate timeline.
              </p>
            </motion.div>
          </div>
