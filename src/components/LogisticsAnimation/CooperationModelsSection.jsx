        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              The difference between a generic explainer studio and a genuine logistics animation partner shows up in the details of your operation. Here is where we earn that difference.
            </p>
          </div>
        </div>
