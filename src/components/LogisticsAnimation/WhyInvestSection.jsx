          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Logistics <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Accuracy to your real operation is the whole point, so our process is built around your operations team, not around generic industry footage. Here is how a project runs from discovery to delivery.
              </p>
            </motion.div>
          </div>
