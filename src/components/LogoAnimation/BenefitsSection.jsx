    ...
    <section className={styles.standoutSection}>
      <div className="container">
        ...
        >
          ...
          <h2 className={styles.mainHeading}>Benefits of Professional <span>Logo Animation</span></h2>
          <p className={styles.headerDesc}>
            What professionally produced logo animation does for a brand that a static logo in a video frame cannot replicate.
          </p>
        </motion.div>
