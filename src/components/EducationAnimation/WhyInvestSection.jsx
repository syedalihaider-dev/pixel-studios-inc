          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Education <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Retention is the real goal, not just visual polish, so our process keeps instructional design in view at every stage. Here is how a project runs from brief to delivery.
              </p>
            </motion.div>
          </div>
