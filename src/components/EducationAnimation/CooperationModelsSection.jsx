        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              An educational video that looks nice but does not teach anything has failed at its one job. Here is how our approach keeps comprehension at the center of the work.
            </p>
          </div>
        </div>
