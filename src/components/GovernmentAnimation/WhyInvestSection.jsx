          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Government <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Public sector work carries its own approval and procurement structure, so our process is built to work within that structure rather than against it.
              </p>
            </motion.div>
          </div>
