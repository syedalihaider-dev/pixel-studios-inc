          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Entertainment <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Creative direction in this category is often subjective, so our process builds in more structured feedback rounds early, when changes are still fast and cheap to make.
              </p>
            </motion.div>
          </div>
