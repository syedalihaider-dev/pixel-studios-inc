        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              A trailer that looks good in isolation is not the same as one that actually builds anticipation for a release. Here is what our studio brings to that distinction.
            </p>
          </div>
        </div>
