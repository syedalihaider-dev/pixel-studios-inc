        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              A rendering that looks good is not the same as one that wins a commission. Here is why architecture firms choose our studio for the work that actually needs to persuade.
            </p>
          </div>
        </div>
