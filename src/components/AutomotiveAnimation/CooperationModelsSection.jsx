        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              Vehicles are engineered down to the millimeter. The animation explaining them should be too. Here is how we protect both the accuracy and the confidentiality of your project.
            </p>
          </div>
        </div>
