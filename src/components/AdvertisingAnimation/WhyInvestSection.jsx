          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Advertising <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Media plans move fast, and our process is built to match that pace without sacrificing creative quality. Here is how a campaign moves from brief to delivery.
              </p>
            </motion.div>
          </div>
