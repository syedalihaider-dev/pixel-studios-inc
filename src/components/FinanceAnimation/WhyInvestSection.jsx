          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Finance <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Compliance accuracy matters as much as clarity in this category, so our process builds review checkpoints into every stage rather than saving them for the end.
              </p>
            </motion.div>
          </div>
