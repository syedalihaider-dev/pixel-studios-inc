      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6">
            ...
            >
              <h2 className={styles.heading}>How Businesses Use Animated Corporate Videos?</h2>
              <p className={styles.description}>
                We create professional corporate video animations to engage audiences, simplify communication, and deliver measurable business outcomes across marketing, training, and stakeholder relations.
              </p>
