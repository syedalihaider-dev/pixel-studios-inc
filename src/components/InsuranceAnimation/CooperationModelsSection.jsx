        ...
        <div className="row justify-content-center text-center mb-4">
          <div className="col-12 col-lg-12">
            ...
            <p className={styles.topParagraph}>
              Simplifying coverage without misstating it is the hardest part of insurance marketing video style. Here is how our insurance video animation company handles that balance.
            </p>
          </div>
        </div>
