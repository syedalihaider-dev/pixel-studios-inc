      ...
      <div className="container">
        <div className="row align-items-center mb-5">
          <div className="col-lg-6 mb-5 mb-lg-0">
            ...
            >
              <p className="subtitle">Animated Commercials</p>
              <h2 className={styles.title}>Turn Viewers into Customers with High-Impact Animated Commercials</h2>
              <p className={styles.description}>
                The average viewer decides on an ad in the first three seconds. Not at the logo reveal. Not at the product shot. In the first three seconds. Most animated commercial production does not begin with that constraint in mind. It begins with the full 30-second runtime and builds toward a hook rather than from one.
              </p>
            </motion.div>
          </div>
