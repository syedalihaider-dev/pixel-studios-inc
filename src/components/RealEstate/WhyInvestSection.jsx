          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <h2 className={styles.mainTitle}>
                Our Real Estate <br />Animation Process
              </h2>

              <p className={styles.subText}>
                Architectural accuracy and marketing appeal have to coexist in every frame. Our process keeps your architects and your sales team in the same loop from the first storyboard to final delivery.
              </p>
            </motion.div>
          </div>
