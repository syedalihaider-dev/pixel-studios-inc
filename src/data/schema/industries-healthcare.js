const schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.pixelstudiosinc.com/industries/healthcare#audience",
      "audienceType": "Healthcare providers, hospitals, clinics, medical organizations, health technology companies, and patient education teams",
      "geographicArea": {
        "@type": "Country",
        "name": "United States"
      }
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/industries/healthcare#service",
      "name": "Animation Services for Healthcare",
      "serviceType": "Healthcare Animation and Video Production Services",
      "category": "Industry-Specific Animation and Video Production",
      "description": "Healthcare animation and video production services for patient education, clinical communication, healthcare awareness, medical processes, staff training, and digital health platforms.",
      "url": "https://www.pixelstudiosinc.com/industries/healthcare",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "audience": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/industries/healthcare",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/industries/healthcare#webpage",
      "url": "https://www.pixelstudiosinc.com/industries/healthcare",
      "name": "Healthcare Animation Services | Pixel Studios Inc.",
      "description": "Healthcare animation and video production services for patient education, clinical communication, healthcare awareness, medical processes, staff training, and digital health platforms.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/industries/healthcare#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Healthcare",
          "item": "https://www.pixelstudiosinc.com/industries/healthcare"
        }
      ]
    }
  ]
