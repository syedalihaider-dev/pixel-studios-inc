const schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.pixelstudiosinc.com/industries/real-estate#audience",
      "audienceType": "Real estate agencies, developers, property marketers, architects, investors, construction firms, and proptech businesses",
      "geographicArea": {
        "@type": "Country",
        "name": "United States"
      }
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/industries/real-estate#service",
      "name": "Animation Services for Real Estate",
      "serviceType": "Real Estate Animation and Video Production Services",
      "category": "Industry-Specific Animation and Video Production",
      "description": "Real estate animation and video production services for property showcases, development presentations, architectural visualization, buyer education, investment communication, and pre-construction marketing.",
      "url": "https://www.pixelstudiosinc.com/industries/real-estate",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "audience": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/industries/real-estate",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/industries/real-estate#webpage",
      "url": "https://www.pixelstudiosinc.com/industries/real-estate",
      "name": "Real Estate Animation Services | Pixel Studios Inc.",
      "description": "Real estate animation and video production services for property showcases, development presentations, architectural visualization, buyer education, investment communication, and pre-construction marketing.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/industries/real-estate#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Real Estate",
          "item": "https://www.pixelstudiosinc.com/industries/real-estate"
        }
      ]
    }
  ]
