const schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.pixelstudiosinc.com/industries/gaming#audience",
      "audienceType": "Game studios, publishers, developers, esports brands, entertainment companies, and interactive-media teams",
      "geographicArea": {
        "@type": "Country",
        "name": "United States"
      }
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/industries/gaming#service",
      "name": "Animation Services for Gaming",
      "serviceType": "Gaming Animation and Video Production Services",
      "category": "Industry-Specific Animation and Video Production",
      "description": "Gaming animation and video production services for game trailers, character animation, cinematics, promotional content, motion graphics, asset showcases, and player-facing campaigns.",
      "url": "https://www.pixelstudiosinc.com/industries/gaming",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "audience": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/industries/gaming",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/industries/gaming#webpage",
      "url": "https://www.pixelstudiosinc.com/industries/gaming",
      "name": "Gaming Animation Services | Pixel Studios Inc.",
      "description": "Gaming animation and video production services for game trailers, character animation, cinematics, promotional content, motion graphics, asset showcases, and player-facing campaigns.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/industries/gaming#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Gaming",
          "item": "https://www.pixelstudiosinc.com/industries/gaming"
        }
      ]
    }
  ]
