const schema = {
  ...
  "@graph": [
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/ai-animation#service",
      "name": "AI Animation Services",
      "serviceType": "AI Animation Services",
      "category": "Animation and Video Production Services",
      "description": "AI-assisted animation services for scalable visual production, rapid concept development, style exploration, marketing content, and branded storytelling.",
      "url": "https://www.pixelstudiosinc.com/ai-animation",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "areaServed": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/ai-animation",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/ai-animation#webpage",
      "url": "https://www.pixelstudiosinc.com/ai-animation",
      "name": "AI Animation Services",
      "description": "AI-assisted animation services for scalable visual production, rapid concept development, style exploration, marketing content, and branded storytelling.",
      "isPartOf": {
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/ai-animation#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "AI Animation Services",
          "item": "https://www.pixelstudiosinc.com/ai-animation"
        }
      ]
    }
  ]
