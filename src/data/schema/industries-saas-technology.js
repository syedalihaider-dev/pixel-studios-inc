const schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.pixelstudiosinc.com/industries/saas-technology#audience",
      "audienceType": "SaaS companies, software businesses, technology firms, startups, product teams, and enterprise technology buyers",
      "geographicArea": {
        "@type": "Country",
        "name": "United States"
      }
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/industries/saas-technology#service",
      "name": "Animation Services for SaaS & Technology",
      "serviceType": "SaaS & Technology Animation and Video Production Services",
      "category": "Industry-Specific Animation and Video Production",
      "description": "Industry-specific animation and video production services for SaaS and technology companies, including product explainers, software demonstrations, onboarding videos, UI workflows, feature launches, and customer education.",
      "url": "https://www.pixelstudiosinc.com/industries/saas-technology",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "audience": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/industries/saas-technology",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/industries/saas-technology#webpage",
      "url": "https://www.pixelstudiosinc.com/industries/saas-technology",
      "name": "SaaS & Technology Animation Services | Pixel Studios Inc.",
      "description": "Industry-specific animation and video production services for SaaS and technology companies, including product explainers, software demonstrations, onboarding videos, UI workflows, feature launches, and customer education.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/industries/saas-technology#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.pixelstudiosinc.com/industries/saas-technology"
        }
      ]
    }
  ]
