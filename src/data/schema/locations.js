const schema = {
  ...
  "@graph": [
    ...
    {
      "@type": "CollectionPage",
      "@id": "https://www.pixelstudiosinc.com/locations#webpage",
      "url": "https://www.pixelstudiosinc.com/locations",
      "name": "Animation Studio Locations | Pixel Studios Inc.",
      "description": "Explore locations served by Pixel Studios Inc. for animation, motion graphics, explainer videos, and related creative services.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      "about": {
      ...
      "inLanguage": "en-US",
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/locations#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Animation Studio Locations | Pixel Studios Inc.",
          "item": "https://www.pixelstudiosinc.com/locations"
        }
      ]
    }
  ]
