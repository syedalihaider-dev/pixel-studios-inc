const schema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.pixelstudiosinc.com/industries/ecommerce#audience",
      "audienceType": "E-commerce brands, online retailers, marketplaces, direct-to-consumer companies, product marketers, and conversion teams",
      "geographicArea": {
        "@type": "Country",
        "name": "United States"
      }
    ...
    {
      "@type": "Service",
      "@id": "https://www.pixelstudiosinc.com/industries/ecommerce#service",
      "name": "Animation Services for E-Commerce",
      "serviceType": "E-Commerce Animation and Video Production Services",
      "category": "Industry-Specific Animation and Video Production",
      "description": "E-commerce animation services for product demonstrations, feature explanations, launch campaigns, social ads, buying guides, customer education, and conversion-focused visual content.",
      "url": "https://www.pixelstudiosinc.com/industries/ecommerce",
      "provider": {
        "@id": "https://www.pixelstudiosinc.com/#organization"
      },
      "audience": {
      ...
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://www.pixelstudiosinc.com/industries/ecommerce",
        "servicePhone": {
          "@type": "ContactPoint",
          "telephone": "+1-443-487-0213",
          "contactType": "sales"
    ...
    {
      "@type": "WebPage",
      "@id": "https://www.pixelstudiosinc.com/industries/ecommerce#webpage",
      "url": "https://www.pixelstudiosinc.com/industries/ecommerce",
      "name": "E-Commerce Animation Services | Pixel Studios Inc.",
      "description": "E-commerce animation services for product demonstrations, feature explanations, launch campaigns, social ads, buying guides, customer education, and conversion-focused visual content.",
      "isPartOf": {
        "@id": "https://www.pixelstudiosinc.com/#website"
      },
      ...
      "breadcrumb": {
        "@id": "https://www.pixelstudiosinc.com/industries/ecommerce#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "E-Commerce",
          "item": "https://www.pixelstudiosinc.com/industries/ecommerce"
        }
      ]
    }
  ]
